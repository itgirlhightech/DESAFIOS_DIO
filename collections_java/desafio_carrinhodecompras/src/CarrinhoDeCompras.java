...
public class CarrinhoDeCompras {
    ...
    public static void main(String[] args) {
        ...
        carrinhoDeCompras.adicionarItem("Lápis", 2.0, 2);
        carrinhoDeCompras.adicionarItem("Caneta", 3.0, 5);
        carrinhoDeCompras.adicionarItem("Caderno", 35.0, 2);
        carrinhoDeCompras.adicionarItem("Marcador", 5.0, 3);
